...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_zynq_ultra_ps_e_v3_0_0_zynq_ultra_ps_e is
 ...
 "UART0_RXD, , , IN, PS_MIO6_500, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "UART0_TXD, , , OUT, PS_MIO7_500, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_TX_CLK, , , OUT, PS_MIO26_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_TXD[0], , , OUT, PS_MIO27_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_TXD[1], , , OUT, PS_MIO28_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_TXD[2], , , OUT, PS_MIO29_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_TXD[3], , , OUT, PS_MIO30_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_TX_CTL, , , OUT, PS_MIO31_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_RX_CLK, , , IN, PS_MIO32_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_RXD[0], , , IN, PS_MIO33_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_RXD[1], , , IN, PS_MIO34_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_RXD[2], , , IN, PS_MIO35_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_RXD[3], , , IN, PS_MIO36_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "GEM0_RGMII_RX_CTL, , , IN, PS_MIO37_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "SD1_SDIO1_DATA_OUT[4], , , INOUT, PS_MIO39_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "SD1_SDIO1_DATA_OUT[5], , , INOUT, PS_MIO40_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "SD1_SDIO1_DATA_OUT[6], , , INOUT, PS_MIO41_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "SD1_SDIO1_DATA_OUT[7], , , INOUT, PS_MIO42_501, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 ...
 "MDIO0_GEM0_MDC, , , OUT, PS_MIO76_502, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,,  " & LF &
 "MDIO0_GEM0_MDIO_OUT, , , INOUT, PS_MIO77_502, LVCMOS33, 12, SLOW, PULLUP, PS_MIO_LVCMOS33_S_12,, " & LF &
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
 ...
 " DDR4_DQ63, , , INOUT, PS_DDR_DQ63_504, DDR4, , , ,PS_DDR4_DQ_OUT34|PS_DDR4_DQ_IN40, RTT_40, 34";
  ...
  attribute PSS_POWER : string;
  attribute PSS_POWER of inst : label is "<BLOCKTYPE name={PS8}> <PS8><FPD><PROCESSSORS><PROCESSOR name={Cortex A-53} numCores={4} L2Cache={Enable} clockFreq={1333.320} load={0.5}/><PROCESSOR name={GPU Mali-400 MP} numCores={2} clockFreq={599.994} load={0.5} /></PROCESSSORS><PLLS><PLL domain={APU} vco={2666.640} /><PLL domain={DDR} vco={2399.976} /><PLL domain={Video} vco={2133.312} /></PLLS><MEMORY memType={DDR4} dataWidth={8} clockFreq={799.992} readRate={0.5} writeRate={0.5} cmdAddressActivity={0.5} /><SERDES><GT name={PCIe} standard={} lanes={} usageRate={0.5} /><GT name={SATA} standard={} lanes={} usageRate={0.5} /><GT name={Display Port} standard={} lanes={} usageRate={0.5} />clockFreq={} /><GT name={USB3} standard={USB3.0} lanes={0}usageRate={0.5} /><GT name={SGMII} standard={SGMII} lanes={0} usageRate={0.5} /></SERDES><AFI master={1} slave={1} clockFreq={50.000} usageRate={0.5} /><FPINTERCONNECT clockFreq={667} Bandwidth={Low} /></FPD><LPD><PROCESSSORS><PROCESSOR name={Cortex R-5} usage={Enable} TCM={Enable} OCM={Enable} clockFreq={533.328} load={0.5}/></PROCESSSORS><PLLS><PLL domain={IO} vco={2999.970} /><PLL domain={RPLL} vco={2133.312} /></PLLS><CSUPMU><Unit name={CSU} usageRate={0.5} clockFreq={180} /><Unit name={PMU} usageRate={0.5} clockFreq={180} /></CSUPMU><GPIO><Bank ioBank={VCC_PSIO0} number={0} io_standard={LVCMOS 3.3V} /><Bank ioBank={VCC_PSIO1} number={0} io_standard={LVCMOS 3.3V} /><Bank ioBank={VCC_PSIO2} number={0} io_standard={LVCMOS 3.3V} /><Bank ioBank={VCC_PSIO3} number={16} io_standard={LVCMOS 3.3V} /></GPIO><IOINTERFACES> <IO name={QSPI} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={NAND 3.1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={USB0} io_standard={} ioBank={VCC_PSIO2} clockFreq={249.997} inputs={3} outputs={1} inouts={8} usageRate={0.5}/><IO name={USB1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth0} io_standard={} ioBank={VCC_PSIO1} clockFreq={124.999} inputs={6} outputs={6} inouts={0} usageRate={0.5}/><IO name={GigabitEth1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth2} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth3} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GPIO 0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GPIO 1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GPIO 2} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GPIO 3} io_standard={} ioBank={VCC_PSIO3} clockFreq={1} inputs={} outputs={} inouts={16} usageRate={0.5}/><IO name={UART0} io_standard={} ioBank={VCC_PSIO0} clockFreq={99.999} inputs={1} outputs={1} inouts={0} usageRate={0.5}/><IO name={UART1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={I2C0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={I2C1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={SPI0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={SPI1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={CAN0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={CAN1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={SD0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={SD1} io_standard={} ioBank={VCC_PSIO1} clockFreq={177.776} inputs={2} outputs={1} inouts={9} usageRate={0.5}/><IO name={Trace} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={TTC0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={TTC1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={TTC2} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={TTC3} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={PJTAG} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={DPAUX} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={WDT0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={WDT1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/></IOINTERFACES><AFI master={0} slave={0} clockFreq={333.333} usageRate={0.5} /><LPINTERCONNECT clockFreq={667} Bandwidth={High} /></LPD></PS8></BLOCKTYPE>/>";
begin
